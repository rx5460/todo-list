...
import { IonPage, IonFab, IonIcon, IonItem, IonInput, IonText,
 IonSelect,IonSelectOption, IonDatetime, IonTextarea, IonLabel } from '@ionic/vue';
...
export default defineComponent({
    components:{
        IonPage, IonFab, IonIcon, IonItem, IonTextarea, IonInput , IonText, IonDatetime, IonLabel 
    ...
    setup(){
        ...
        function addTask(){
            ...
            .then(() => {
                ...
                console.log('Document sucessfulyy written');  
            })
            .catch((error) =>{
